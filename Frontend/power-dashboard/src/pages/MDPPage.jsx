...
export default function MDPPage() {
  ...
  const handleAcknowledge = async (id) => {
    try {
      await api.put(`/api/alarms/${id}/acknowledge`, { note: 'Acknowledged via MDP dashboard' })
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {/* 2. Visual Horizontal Bar Chart of Voltage Phase and Relays */}
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        ...
        <SectionCard title="Cabinet Parameters & Relays" icon={ShieldAlert}>
          <div className="flex flex-col gap-3 justify-center h-full pb-4">
            <div className="flex items-center justify-between p-3 rounded-lg bg-[#101a33] border border-[#344364]">
              <span className="text-xs text-[#aeb9d5] font-bold">Earth Fault Relay</span>
            ...
            <div className="flex items-center justify-between p-3 rounded-lg bg-[#101a33] border border-[#344364]">
              <span className="text-xs text-[#aeb9d5] font-bold">Overcurrent Relay</span>
              <span className="px-2.5 py-0.5 rounded text-[11px] font-black tracking-wide bg-green-500/20 text-green-400 border border-green-500/30">
                HEALTHY
              </span>
            </div>
            ...
            <div className="flex items-center justify-between p-3 rounded-lg bg-[#101a33] border border-[#344364]">
              <span className="text-xs text-[#aeb9d5] font-bold">Surge Protection</span>
              <span className="px-2.5 py-0.5 rounded text-[11px] font-black tracking-wide bg-green-500/20 text-green-400 border border-green-500/30">
                ONLINE
              </span>
            </div>
      ...
      {/* 4. Active Alarms & Cabinet Status Relays */}
        ...
        <div className="lg:col-span-2">
          <SectionCard title="Active MDP Alarms" icon={Bell}>
            ...
            {!alarmsLoading && (!alarms || alarms.length === 0) ? (
              <p className="text-xs text-[#aeb9d5] py-4 italic text-center">No active alarms for this MDP.</p>
            ) : (
          ...
          <div className="flex flex-col gap-3 justify-center h-full pb-4">
            ...
            <div className="flex items-center justify-between p-2.5 rounded-lg bg-[#101a33] border border-[#344364]">
              ...
              <span className={`px-2.5 py-0.5 rounded text-[11px] font-black tracking-wide ${
                ...
                {latestReading.intruder_alarm ? 'INTRUSION DETECTED' : 'SECURE'}
              </span>
            </div>
          </div>
        </SectionCard>
